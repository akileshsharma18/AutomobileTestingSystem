...
$sql = "UPDATE vehicles set es=".$_POST['es'].",eop=".$_POST['eop'].",ms=".$_POST['ms'].",nat=".$_POST['nat'].",fa=".$_POST['fa'].",art=".$_POST['art']." where name=\"".$_POST["name"]."\" and model =".$_POST["model"];
            ...
            <nav class="mb-1 navbar navbar-expand-lg navbar-light winter-neva-gradient scrolling-navbar fixed-top">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent-555">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="dashDBAdminEnterValue1.php">ENTER VALUE</a>
                        </li>
                    ...
                    <ul class="navbar-nav ml-auto nav-flex-icons">
                        <li>
                            <button type="button" class="btn btn-sm btn-primary button1">LOG OUT</button>
                        </li>
                    </ul>
                </div>
            </nav>
