...
$sql = "INSERT INTO vehicles values(\"".$_POST['name']."\",".$_POST['model'].",\"".$_POST['company']."\",\"".$_POST['category']."\",".$_POST['es'].",".$_POST['eop'].",".$_POST['ms'].",".$_POST['nat'].",".$_POST['fa'].",".$_POST['art'].")";
...
<html>
    ...
    <script>
        alert("Entered values successfully");
    </script>
